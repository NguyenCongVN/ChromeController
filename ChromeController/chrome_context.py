...
def ChromeContext(binary, dbg_port, is_existing, *args, **kwargs):
    '''
    ...
    try:
        chrome_instance = ChromeRemoteDebugInterface(binary=binary, dbg_port=dbg_port, is_existing=is_existing, *args,
                                                     **kwargs)
        chrome_created = True
